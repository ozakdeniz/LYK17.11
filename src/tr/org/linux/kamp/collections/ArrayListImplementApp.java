...
public class ArrayListImplementApp {
	
	public static void main(String[] args) {
		ArrayListImplement<String> liste = new ArrayListImplement<>();
		ArrayListImplement<String> liste2 = new ArrayListImplement<>();
		
		liste.addItem("JAVA PROGRAMLAMA");
		liste.addItem("LİNUX YAZ KAMPI");
		liste.addItem("ÖZGÜR YAZILIM");
		liste.addItem("GNU LİNUX");
		liste2.addItem("özgür");
